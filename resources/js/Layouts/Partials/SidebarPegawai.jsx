...
function SidebarNavLink({ href, active, children, isCollapsed }) {
...
function SidebarDropdown({ title, children, isCollapsed, icon }) {
...
export default function SidebarPegawai({ isCollapsed }) {
    return (
        <div className="space-y-2">
            {/* Menu utama - Daftar Kegiatan Saya */}
            <SidebarNavLink 
            ...
            <SidebarNavLink 
                href={route('pegawai.kegiatan.myIndex')} 
                active={route().current('pegawai.kegiatan.myIndex', { tahapan: undefined })}
                isCollapsed={isCollapsed}
            >
                Tugas Aktif
            </SidebarNavLink>
            ...
            {/* Tugas Selesai */}
            <SidebarNavLink 
                href={route('pegawai.kegiatan.myIndex', { tahapan: 'selesai' })} 
                active={route().current('pegawai.kegiatan.myIndex', { tahapan: 'selesai' })}
                isCollapsed={isCollapsed}
            >
                Tugas Selesai
            </SidebarNavLink>
            ...
            {/* Menu Download Laporan Berita */}
            <SidebarNavLink 
                href={route('laporan-berita.create')} 
                active={route().current('laporan-berita.create')}
                isCollapsed={isCollapsed}
            >
