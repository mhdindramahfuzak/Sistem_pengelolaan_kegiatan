...
const ActivityCard = ({ activities }) => (
    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl shadow-lg border border-gray-100 p-6 h-full">
        <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 flex items-center"><BellIcon /><span className="ml-3">Aktivitas Terbaru</span></h3>
...
// --- PERBAIKAN: Komponen ChartCard diubah untuk menampilkan satu jenis grafik saja ---
...
export default function Dashboard({ auth, stats, chartData, activities, events }) {
    ...
    const defaultActivities = [
        { title: 'Proposal baru masuk dari PT ABC', time: '2 jam yang lalu' },
        { title: 'Kegiatan "Training IT" telah selesai', time: '5 jam yang lalu' },
        { title: 'Tim baru dibentuk untuk proyek X', time: '1 hari yang lalu' },
        { title: 'Laporan bulanan telah dikirim', time: '2 hari yang lalu' },
    ];
    ...
    // --- PERBAIKAN: Fungsi ini sekarang akan merender dua grafik untuk setiap set data ---
    const renderCharts = () => {
        ...
        // Menggunakan flatMap untuk membuat array berisi dua komponen ChartCard untuk setiap data
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {chartData && Object.keys(chartData).length > 0 && (
                        <div className="mb-8">
                            ...
                            {/* --- PERBAIKAN: Grid untuk menampilkan beberapa grafik --- */}
